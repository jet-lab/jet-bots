...
#time ts-node ../src/index.ts asks -c d -m ETH/USDC
#time ts-node ../src/index.ts bids -c d -m ETH/USDC
time ts-node ../src/index.ts send-test-order -c d -k ~/.config/solana/taker.json -m ETH/USDC -t USDC -p 1000 -s 0.1
#time ts-node ../src/index.ts ask-orders -c d -m ETH/USDC
#time ts-node ../src/index.ts bid-orders -c d -m ETH/USDC
